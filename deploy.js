...
function updateRemoteApp() {
  return ssh.execCommand(
    'rm -rf riot-express-todo-list && mkdir riot-express-todo-list && cp -r riot-express-todo-list-temp/* riot-express-todo-list/ && rm -rf riot-express-todo-list-temp', {
      cwd: '/home/ubuntu'
  });
}
